---
name: pinecall-react-native
description: >-
  @pinecall/react-native — voice calls in React Native apps. Use when the user is building, configuring, or debugging with @pinecall/sdk. Keywords: react native, expo, mobile, voice call.
license: MIT
---

# @pinecall/react-native

@pinecall/react-native — voice calls in React Native apps.

This skill bundles the official Pinecall documentation for **@pinecall/react-native**. The
...
|------|----------------|------|
| **@pinecall/react-native** | Native AI voice calls for React Native — CallKit + native WebRTC, the same headless CallClient API as @pinecall/ionic. | [`references/mobile/react-native.md`](references/mobile/react-native.md) · [docs](https://docs.pinecall.io/mobile/react-native) |
