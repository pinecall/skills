---
name: pinecall-messaging
description: >-
  Messaging channel — WhatsApp agents. Use when the user is building, configuring, or debugging with @pinecall/sdk. Keywords: whatsapp, messaging, text channel.
license: MIT
---

# Messaging

Messaging channel — WhatsApp agents.

This skill bundles the official Pinecall documentation for **Messaging**. The
