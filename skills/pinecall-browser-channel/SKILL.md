---
name: pinecall-browser-channel
description: >-
  Browser and mobile channel — WebRTC voice from the browser, token endpoint. Use when the user is building, configuring, or debugging with @pinecall/sdk. Keywords: webrtc, browser, token endpoint, mobile channel.
license: MIT
---

# Browser & Mobile

Browser and mobile channel — WebRTC voice from the browser, token endpoint.

This skill bundles the official Pinecall documentation for **Browser & Mobile**. The
