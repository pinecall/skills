---
name: pinecall-develop
description: >-
  Developer workflow — testing agents, the MCP server, Agent Skills for your IDE, security. Use when the user is building, configuring, or debugging with @pinecall/sdk. Keywords: testing, test agents, mcp server, agent skills, security, develop, ship.
license: MIT
---

# Develop & Ship

Developer workflow — testing agents, the MCP server, Agent Skills for your IDE, security.

This skill bundles the official Pinecall documentation for **Develop & Ship**. The
